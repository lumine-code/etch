...
describe("function refs", () => {
  ...
  it("allow updating", async function () {
    ...
    let component = {
      render() {
        return etch.dom("div", null, etch.dom("div", { ref: refFunc(testNumber) }, "Testing"));
      },
  ...
  it("allow switching from text to function and back", async function () {
    let saved_node;
    const refFunc = ["savedNode", (node) => (saved_node = node)];
    ...
    let component = {
      render() {
        return etch.dom(
          ...
          testNumber <= 1
            ? etch.dom("span", { ref: refFunc("span") }, "Testing ", testNumber)
            : null,
      ...
      let component = {
        render() {
          return etch.dom(
            ...
            null,
            testNumber <= 2
              ? etch.dom(Component, { ref: refFunc("Component") }, "Testing ", testNumber)
              : null,
            testNumber <= 1
              ? etch.dom("span", { ref: refFunc("span") }, "Testing ", testNumber)
              : null,
