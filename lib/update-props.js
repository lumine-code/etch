    ...
    for (var name in newProps) {
      ...
      if (name === 'dataset') {
        ...
        if (newValue !== oldValue) {
          ...
          } else if (newVirtualNode && (newVirtualNode.tag === 'input' || newVirtualNode.tag === 'textarea')
            && name === 'value' && domNode[name] === newValue) {
            // Do not update `value` of an `input` or `textarea` unless it
            // differs. Every change will reset the cursor position.
          } else {
